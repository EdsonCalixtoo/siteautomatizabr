...
const About = () => {
  return (
    <Layout>
      {/* Header */}
      <section className="pt-40 pb-16 bg-gradient-to-b from-blue-50 via-blue-50 to-white relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-10 w-72 h-72 bg-blue-100/20 rounded-full blur-3xl translate-y-1/2 -translate-x-1/4 animate-bounce-slow" />
        
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-6 animate-slide-up">
            <div className="inline-flex items-center justify-center gap-2 text-blue-600 font-semibold text-sm uppercase tracking-wider mb-4 bg-blue-100/50 px-4 py-2 rounded-full border border-cyan-200">
              <span className="w-2 h-2 rounded-full bg-blue-600" />
              Tecnologia brasileira
            </div>
            <h1 className="font-heading text-5xl md:text-6xl font-bold text-gray-900 leading-tight">
              A <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-700">AUTOMATIZA</span>
            </h1>
            <p className="text-2xl text-blue-600 font-semibold italic">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            <div className="space-y-6 animate-slide-up" style={{ animationDelay: '100ms' }}>
              <div className="flex items-center gap-3">
                <div className="w-1 h-10 bg-gradient-to-b from-blue-600 to-blue-700" />
              ...
              <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                ...
                <p className="text-xl font-semibold text-blue-600 italic pt-4 border-l-4 border-blue-600 pl-4">
            ...
            <div className="mt-20 space-y-12">
              <div className="text-center space-y-4">
                <h2 className="font-heading text-3xl md:text-4xl font-bold text-gray-900">
                  Inovação aplicada ao <span className="text-blue-600">dia a dia</span>
                </h2>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    {[
                      ...
                      <div key={i} className="flex items-center gap-3 bg-blue-50 p-3 rounded-xl border border-blue-100 group hover:border-cyan-300 transition-all">
                ...
                <div className="relative">
                  ...
                  <div className="relative bg-white p-8 rounded-3xl border border-blue-100 shadow-xl space-y-6">
      ...
      <section className="py-20 bg-gradient-to-b from-slate-900 to-gray-900 text-white relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-blue-600/10 rounded-full blur-3xl opacity-50" />
        <div className="container mx-auto px-4 relative z-10">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <h2 className="font-heading text-4xl font-bold text-gray-900">
              Compromisso com quem <span className="text-blue-600">vive na estrada</span>
            </h2>
            <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
              <p>
