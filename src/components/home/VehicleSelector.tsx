  ...
  return (
    <div className="w-full max-w-6xl mx-auto mb-16">
      ...
      <div className="relative group">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-green-600/40 via-blue-600/40 to-green-600/40 rounded-3xl blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
        
        {/* Premium Content Container */}
        <div className="relative bg-gradient-to-br from-gray-800/40 via-gray-900/60 to-gray-950/80 backdrop-blur-2xl rounded-3xl p-12 border border-gray-700/30 shadow-2xl group-hover:border-green-500/50 transition-all duration-500 overflow-hidden">
          
          {/* Decorative elements */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-green-500/10 to-transparent rounded-full blur-3xl -mr-32 -mt-32 group-hover:scale-150 transition-transform duration-700" />
          ...
          <div className="mb-14 relative z-10">
            <div className="flex items-center justify-center gap-2 mb-4">
              <div className="h-1 w-12 bg-gradient-to-r from-yellow-400 to-transparent rounded-full" />
          ...
          <div className="flex gap-2 mb-12 justify-center relative z-10">
            {[
              ...
              <div key={idx} className="flex items-center gap-2">
                <div className={`relative ${item.active ? "bg-gradient-to-r from-green-500 to-green-600" : "bg-gray-700/50"} rounded-full p-2.5 transition-all duration-500 shadow-lg ${item.active ? "shadow-green-500/50" : ""}`}>
                  {item.active ? (
                ...
                <span className={`text-xs font-semibold hidden sm:inline ${item.active ? "text-yellow-400" : "text-gray-500"}`}>
                  {item.label}
                </span>
                {idx < 2 && <div className={`w-8 h-0.5 ${item.active ? "bg-gradient-to-r from-green-500 to-transparent" : "bg-gray-700/30"} transition-all duration-500 hidden sm:block`} />}
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-10 relative z-10">
            ...
            <div className="group/card relative">
              <div className="absolute inset-0 bg-gradient-to-br from-green-600/20 to-blue-600/10 rounded-2xl opacity-0 group-hover/card:opacity-100 blur transition-opacity duration-500" />
              <div className="relative bg-gradient-to-br from-gray-700/40 to-gray-800/40 backdrop-blur-md border border-gray-600/30 rounded-2xl p-6 hover:border-green-500/50 transition-all duration-300">
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-2.5 bg-gradient-to-br from-green-500/20 to-green-600/10 rounded-lg border border-green-500/30">
                ...
                <Select value={selection.brand || ""} onValueChange={handleBrandChange}>
                  <SelectTrigger className="bg-gradient-to-r from-gray-800/60 to-gray-900/60 border border-gray-600/50 text-white hover:border-green-500/70 focus:border-green-500 focus:ring-2 focus:ring-green-500/30 transition-all duration-300 backdrop-blur-md text-base font-medium">
                  ...
                  <SelectContent className="bg-gray-800/95 border-gray-700/50 backdrop-blur-md">
                    {VEHICLE_BRANDS.map((brand) => (
                      <SelectItem
                        key={brand}
                        value={brand}
                        className="text-white focus:bg-gradient-to-r focus:from-green-600/50 focus:to-green-500/50 hover:bg-green-600/30 transition-colors cursor-pointer"
                      >
                        {brand}
                      </SelectItem>
                    ))}
          ...
          <div className="flex flex-col gap-4 relative z-10">
            ...
            <Button
              ...
              className={`w-full py-7 font-bold text-lg rounded-2xl transition-all duration-500 transform ${
                isComplete
                  ? "bg-gradient-to-r from-green-500 via-green-600 to-green-700 hover:from-green-600 hover:via-green-700 hover:to-cyan-800 text-white shadow-xl hover:shadow-2xl hover:shadow-green-500/50 hover:scale-105 active:scale-95"
            ...
            {isComplete && (
              <div className="px-6 py-4 bg-gradient-to-r from-green-500/15 via-blue-500/10 to-green-500/15 border border-green-500/40 rounded-2xl text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
